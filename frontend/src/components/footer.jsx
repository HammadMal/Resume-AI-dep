        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:flex lg:items-start flex-col">
            ...
            <p className="text-white/60 text-sm mt-2">
              Enhance your job search with AI-powered resume optimization and analysis.
            </p>
          </div>
          ...
          <div className="lg:flex lg:items-start flex-col">
            ...
            <ul className="flex space-x-4">
              <li>
                <a href="#" className="bg-white/10 hover:bg-white/20 transition-colors p-2 rounded-lg flex items-center justify-center">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#reviews" className="text-white/60 hover:text-white text-sm transition-colors">Reviews</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to ="/aboutus" className="text-white/60 hover:text-white text-sm transition-colors">About Us</Link>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="text-white/60 hover:text-white text-sm transition-colors">Report a bug</a>
              </li>
            </ul>
          </div>
        </div>
